...
namespace BethanysPieShop.Migrations
{
    ...
    [Migration("20181226074433_PieReview_7")]
    partial class PieReview_7
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPieShop.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("BethanysPieShop.Models.LikeReview", b =>
                {
                    ...
                    b.HasIndex("PieReviewId");

                    b.ToTable("LikesReview");
                });
            ...
            modelBuilder.Entity("BethanysPieShop.Models.LikeReview", b =>
                {
                    b.HasOne("BethanysPieShop.Models.PieReview", "PieReview")
                        .WithMany("Likes")
                        .HasForeignKey("PieReviewId")
            ...
            modelBuilder.Entity("BethanysPieShop.Models.PieReview", b =>
                {
                    ...
                    b.HasOne("BethanysPieShop.Identity.AppUser", "UserReview")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BethanysPieShop.Identity.AppUser")
                        .WithMany("Claims")
